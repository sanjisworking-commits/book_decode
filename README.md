...
**Phase 3 — AI Argument Spine extraction (feature branch)**

Phases 0–2 are on `main`. Phase 3 extracts English Argument Spine JSON from normalised chapter chunks via an OpenAI-compatible LLM (or `LLM_MOCK` for offline runs). See [`backend/README.md`](backend/README.md).
