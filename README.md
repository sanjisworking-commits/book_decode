...
Phases 0–6 on this branch. Final schema/source validation with repair retries; only valid bilingual spines are marked completed. See [`backend/README.md`](backend/README.md).
