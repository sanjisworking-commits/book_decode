...
Phases 0–5 on this branch. After English spine synthesis, Phase 5 fills `statement_hinglish` / `explanation_hinglish` while preserving node IDs and source grounding. See [`backend/README.md`](backend/README.md).
