...
Phases 0–4 are on this branch / heading to `main`. Hierarchical `book.json` feeds chunking; Phase 3 extracts partial spines; Phase 4 synthesises one English chapter spine. See [`docs/CANONICAL_BOOK_SCHEMA.md`](docs/CANONICAL_BOOK_SCHEMA.md) and [`backend/README.md`](backend/README.md).
